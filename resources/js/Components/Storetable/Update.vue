...
onMounted(() => {
    ...
    form.TYPES = props.TYPES;
    form.BLOCKED = props.BLOCKED;
    form.CUTOFFTIME = props.CUTOFFTIME;
    ...
    watch(() => props.CUTOFFTIME, (newValue) => {
        form.CUTOFFTIME = newValue;
    });
});
</script>

<template>
    <Modal title="Update Store" @toggle-active="toggleActive" :show-modal="showModal">
        <template #content >
